...
> `app/globals.css`의 shadcn CSS 변수와 대응. `:root` = 라이트, `.dark` = 다크.

```css
:root {
  /* 라이트 모드 (Cal 기반) */
  --background: 0 0% 100%;           /* canvas #ffffff */
  --card: 210 17% 98%;               /* surface-1 #f8f9fa */
  --popover: 0 0% 96%;               /* surface-2 #f5f5f5 */
  --muted: 0 0% 94%;                 /* surface-3 #efefef */

  --foreground: 0 0% 7%;             /* ink #111111 */
  --muted-foreground: 220 9% 31%;    /* ink-muted #374151 */
  --card-foreground: 0 0% 7%;

  --primary: 162 88% 46%;            /* mint #10d9a0 */
  --primary-foreground: 220 30% 5%;  /* 다크 텍스트 on primary */
  --ring: 162 66% 36%;               /* primary-focus #0aaa7d (라이트에서 명도 확보) */

  --border: 220 13% 91%;             /* hairline #e5e7eb */
  --input: 220 13% 91%;
